...
function setup() {
	...
	bobObject2 = new Bob(475,400,10);
	bobObject3 = new Bob(450,400,10);
	bobObject4 = new Bob(425,400,10);
...
function keyPressed(){
	if(keyCode===UP_ARROW){
		Matter.Body.applyForce(bobObject5.body,bobObject5.body.position,{x:-0.020,y:-0.020})
	}
}
